...
import { formatOutcome, stripFrontmatter } from "./format";
import { indexSkills } from "./indexer";
import { resolveToken, resolveTokens } from "./resolver";
import {
	buildNamespaceTree,
	buildPathTree,
	buildSkillTree,
...
export function buildCli() {
	...
	program
		...
		.option("-S, --scope <scope>", "Target scope (project, user, or both)", "both")
