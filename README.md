...
skillset explain <path>     # explain a source or generated path (lowering, lock provenance, hashes; add --json for records)
...
skillset doctor             # aggregate lint issues, drift, warnings, and lowering advisories; add --json for records
