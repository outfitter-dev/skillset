...
- Emit source instructions from `.skillset/instructions/**/*.md` (with `.skillset/rules/**/*.md` as a compatibility alias) to Claude `.claude/rules/**/*.md` and Codex directory-local `AGENTS.md` files without overwriting unmanaged guidance.
