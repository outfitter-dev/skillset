...
export const skillsetFeatureRegistry = defineFeatureRegistry([
  ...
  feature({
    ...
    evidence: [test("apps/skillset/src/__tests__/dev-watch.test.ts", "SET-210 dev watch path, debounce, preview, and validation coverage")],
    id: "dev-watch",
    kind: "workflow",
    ...
    status: "implemented",
    summary: "Runs a foreground preview-only authoring loop over source diagnostics and generated-output drift.",
    targetSupport: notTargetRuntime(),
    title: "Dev Watch",
