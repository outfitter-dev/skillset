...
export const skillsetFeatureRegistry = defineFeatureRegistry([
  ...
  feature({
    ...
    status: "implemented",
    summary: "Runs a foreground authoring loop over source diagnostics and generated-output drift, with explicit write mode for generated writes.",
    targetSupport: notTargetRuntime(),
    title: "Dev Watch",
  ...
  feature({
    ...
    id: "plugin-manifests",
    kind: "source",
    renderOwner: "packages/core/src/render-plugin-manifest.ts",
