...
Body.
`,
      ".skillset/src/skills/writer/hooks/local-stop.json": JSON.stringify({
        events: ["Stop"],
...
Body.
`,
      ".skillset/src/plugins/demo/skills/writer/hooks/local-stop.json": JSON.stringify({
        events: ["Stop"],
...
hooks:
  Notification:
    - notify
`,
      ".skillset/src/plugins/demo/hooks/notify.json": JSON.stringify({
        events: ["Notification"],
...
hooks:
  Stop:
    - hook: stop-policy
      match: main
`,
      ".skillset/src/plugins/demo/hooks/stop-policy.json": JSON.stringify({
        events: ["Stop"],
