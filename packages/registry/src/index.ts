...
const snapshots = [
  ...
  snapshot({
    ...
    format: {
      ...
      filePattern: "hooks/hooks.json",
      handlerFields: ["type", "command", "prompt", "timeout", "loop_limit", "failClosed", "matcher", "model"],
      rootFields: ["version", "hooks"],
      shape: "versioned-flat-event-map",
      supportedHandlerTypes: ["command", "prompt"],
    },
    id: "cursor-hooks",
    provenance: {
      ...
      sources: [
        ...
        { url: "https://github.com/cursor/plugins/blob/e87eaecc7bd3a06160035b5bc1a76d8cd695273a/ralph-loop/hooks/hooks.json" },
      ],
    },
    target: "cursor",
