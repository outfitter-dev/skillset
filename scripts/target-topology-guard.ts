...
export const TARGET_TOPOLOGY_ALLOWLIST: readonly TargetTopologyAllowlistEntry[] = [
  ...
  allow("packages/schema/src/examples.ts", 205, 24, "skillsetSchemaExamples", "R1", '["claude", "codex"]', "Schema example documents an intentionally provider-scoped hook."),
  allow("packages/schema/src/examples.ts", 359, 18, "skillsetSchemaExamples", "R1", '["claude", "codex"]', "Schema example documents an intentionally provider-scoped hook."),
  allow("packages/schema/src/examples.ts", 406, 32, "skillsetSchemaExamples", "R1", '["claude", "codex"]', "Skill eval example demonstrates an intentionally narrowed case target matrix."),
  allow("packages/schema/src/examples.ts", 445, 16, "skillsetSchemaExamples", "R1", '["claude", "codex", "cursor"]', "Schema example demonstrates the complete activation targets field."),
  ...
  allow("packages/core/src/render-result-collector.ts", 819, 10, "companionForPath", "R2", 'target === "claude" || target === "cursor"', "Commands are provider-native companion formats for Claude and Cursor."),
  allow("packages/core/src/render-result-collector.ts", 825, 10, "companionForPath", "R2", 'target === "claude" || target === "cursor"', "Agents are provider-native companion formats for Claude and Cursor."),
  allow("packages/core/src/render.ts", 1349, 7, "copyPluginCompanionFiles", "R2", 'target === "codex" || target === "cursor"', "Codex and Cursor hooks require normalized provider-native output."),
  allow("packages/core/src/render.ts", 1369, 10, "copyPluginCompanionFiles", "R2", 'target === "codex" || target === "cursor"', "Codex and Cursor skip copying Claude-native hook files."),
  ...
  allow("packages/core/src/render.ts", 1331, 5, "copyPluginCompanionFiles", "R3", 'target === "claude" -> target === "codex" -> else [cursor]', "Provider-native companion file sets are intentionally distinct."),
