...
export const TARGET_TOPOLOGY_ALLOWLIST: readonly TargetTopologyAllowlistEntry[] = [
  ...
  allow("packages/core/src/render-result-collector.ts", 1411, 10, "companionForPath", "R2", 'target === "claude" || target === "cursor"', "Commands are provider-native companion formats for Claude and Cursor."),
  allow("packages/core/src/render-result-collector.ts", 1417, 10, "companionForPath", "R2", 'target === "claude" || target === "cursor"', "Agents are provider-native companion formats for Claude and Cursor."),
  allow("packages/core/src/render-result-collector.ts", 756, 5, "pluginAuthorRenderFacts", "R3", 'target === "claude" -> target === "codex" -> else [cursor]', "Provider-native author omission diagnostics use provider names."),
  allow("packages/core/src/render-result-collector.ts", 765, 11, "pluginAuthorRenderFacts", "R3", 'target === "claude" -> target === "codex" -> else [cursor]', "Provider-native author omission diagnostics use distinct stable codes."),
