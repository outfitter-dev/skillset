...
export const TARGET_TOPOLOGY_ALLOWLIST: readonly TargetTopologyAllowlistEntry[] = [
  ...
  allow("packages/core/src/render-result-collector.ts", 1390, 10, "companionForPath", "R2", 'target === "claude" || target === "cursor"', "Commands are provider-native companion formats for Claude and Cursor."),
  allow("packages/core/src/render-result-collector.ts", 1396, 10, "companionForPath", "R2", 'target === "claude" || target === "cursor"', "Agents are provider-native companion formats for Claude and Cursor."),
  allow("packages/core/src/render-result-collector.ts", 735, 5, "pluginAuthorRenderFacts", "R3", 'target === "claude" -> target === "codex" -> else [cursor]', "Provider-native author omission diagnostics use provider names."),
  allow("packages/core/src/render-result-collector.ts", 744, 11, "pluginAuthorRenderFacts", "R3", 'target === "claude" -> target === "codex" -> else [cursor]', "Provider-native author omission diagnostics use distinct stable codes."),
  ...
  allow("packages/core/src/render-plugin-manifest.ts", 54, 7, "renderPluginManifest", "R3", 'target === "claude" -> target === "codex" -> else [cursor]', "Provider-native plugin author shapes are intentionally distinct."),
  allow("packages/core/src/render-plugin-manifest.ts", 86, 5, "renderPluginManifest", "R3", 'target === "claude" -> target === "codex" -> else [cursor]', "Provider-native plugin manifests have distinct formats."),
  allow("packages/core/src/render-plugin-manifest.ts", 262, 3, "withOptionalSurfacePaths", "R3", 'target === "claude" -> target === "codex" -> else [cursor]', "Provider-native plugin surfaces have distinct destination fields."),
