...
export const TARGET_TOPOLOGY_ALLOWLIST: readonly TargetTopologyAllowlistEntry[] = [
  ...
  allow("packages/schema/src/examples.ts", 48, 20, "skillsetSchemaExamples", "R1", '["claude", "codex"]', "Report example documents an intentionally selected external-fixture target set."),
  allow("packages/schema/src/examples.ts", 123, 18, "skillsetSchemaExamples", "R1", '["claude", "codex", "cursor"]', "Schema example demonstrates the complete targets field."),
  allow("packages/schema/src/examples.ts", 169, 20, "skillsetSchemaExamples", "R1", '["claude", "codex", "cursor"]', "Schema example demonstrates the complete marketplace targets field."),
  allow("packages/schema/src/examples.ts", 281, 24, "skillsetSchemaExamples", "R1", '["claude", "codex"]', "Schema example documents an intentionally provider-scoped hook."),
  ...
  allow("packages/core/src/render-result-collector.ts", 834, 10, "companionForPath", "R2", 'target === "claude" || target === "cursor"', "Commands are provider-native companion formats for Claude and Cursor."),
  allow("packages/core/src/render-result-collector.ts", 840, 10, "companionForPath", "R2", 'target === "claude" || target === "cursor"', "Agents are provider-native companion formats for Claude and Cursor."),
