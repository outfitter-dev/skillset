...
- [Source reference](reference/source/README.md) documents the canonical workspace layout, rules, and preprocessing.
...
- [Generated-state rebuild](guides/generated-state-rebuild.md) gives the owner-reviewed, recoverable path from pre-v4 locks to current projection roles.
