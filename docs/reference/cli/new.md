---
description: The Skillset new command can create a new plugin, skill, project agent, instruction, or hook in source.
---
...
Create a new plugin, skill, project agent, instruction, or hook in source.
