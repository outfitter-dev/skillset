...
Move the self-hosted workspace onto the dedicated `skillset.yaml` and `skillset/` layout, with change state under `changes/`, while refreshing generated Skillset guidance, fixture instructions, and the generated lockfile contract to use `skillset.lock`.
